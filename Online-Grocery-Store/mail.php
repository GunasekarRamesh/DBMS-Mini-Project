			...
			<div class="agileinfo_mail_grids">
				<div class="col-md-4 agileinfo_mail_grid_left">
					<ul>
						...
						<li>address<span>Yasasree Traders,
							Perandapalli,Hosur,
							Krishnagiri,Tamilnadu-635109</span></li>
					</ul>
					<ul>
						<li><i class="fa fa-envelope" aria-hidden="true"></i></li>
						<li>email<span><a href="ystgrocerystore@gmail.com">ystgrocerystore@gmail.com</a></span></li>
					</ul>
					<ul>
						<li><i class="fa fa-phone" aria-hidden="true"></i></li>
						<li>call to us<span>(+91) 9789133716</span></li>
					</ul>
				</div>
