...
<body>
    ...
    <div class="agileits_header">
      <div class="w3l_offers"> <a href="#">Our goal is your satisfaction </a> </div>
    ...
    <div class="logo_products">
      <div class="container">
        <div class="w3ls_logo_products_left">
          <h1><a href="index.php"><span>Sanjay</span> Traders</a></h1>
        </div>
        ...
        <div class="w3ls_logo_products_left1">
          <ul class="phone_email">
            <li><i class="fa fa-phone" aria-hidden="true"></i> <a href="tel:+919686631649">(+91) 9686631649</a></li>
            <li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:sanketh23@gmail.com"> <a href="mailto:sanketh23@gmail.com">sanketh23@gmail.com</a></li>
          </ul>
        </div>
        <div class="clearfix"></div>
      </div>
